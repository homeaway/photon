...
public class ManifestPartitionProducerTest {
    ...
    @Test
    public void testProducePartitionResults() {
        ...
        PartitionProducer<PartitionManifestResult, PhotonBeamReader> partitionProducer =
                new ManifestPartitionProducer(beamCache, beamDataManifestDao,
                        partitionHelper, FORWARD,
