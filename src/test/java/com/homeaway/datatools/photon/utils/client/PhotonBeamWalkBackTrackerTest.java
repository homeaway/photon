...
public class PhotonBeamWalkBackTrackerTest {
    ...
    public void testJsonRoundTrip() {
        ...
        PhotonBeamWalkBackTracker tracker = new PhotonBeamWalkBackTracker();
        tracker.setBackoffKey(UUID.randomUUID());
        tracker.setStart(Instant.now());
        tracker.setEnd(Instant.now());
        tracker.setActive(false);
        Assert.assertEquals(tracker, JsonHelper.jsonRoundTrip(tracker, PhotonBeamWalkBackTracker.class));
    }
